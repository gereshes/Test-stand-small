// ======================================================================
// DS ADC to UART.v generated from TopDesign.cysch
// 10/07/2017 at 20:58
...
module ADC_DelSig_v3_20_0 (
	...
	cy_clock_v1_0
		#(.id("45203930-5474-4ebd-adbe-6a67324cacb0/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_psoc3_pins_v1_10
		#(.id("45203930-5474-4ebd-adbe-6a67324cacb0/20681f4c-d171-47ae-a1cb-d832cd711191"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("45203930-5474-4ebd-adbe-6a67324cacb0/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("168350168.350168"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_250));
...
module top ;
	...
	wire [0:0] tmpOE__PLUS_net;
	wire [0:0] tmpFB_0__PLUS_net;
	wire [0:0] tmpIO_0__PLUS_net;
	wire [0:0] tmpINTERRUPT_0__PLUS_net;
	electrical [0:0] tmpSIOVREF__PLUS_net;
	...
	cy_psoc3_pins_v1_10
		...
		PLUS
		 (.oe(tmpOE__PLUS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PLUS_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__PLUS_net[0:0]}),
		  .siovref(tmpSIOVREF__PLUS_net),
		  .interrupt({tmpINTERRUPT_0__PLUS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PLUS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MINUS_net;
	wire [0:0] tmpFB_0__MINUS_net;
	wire [0:0] tmpIO_0__MINUS_net;
	wire [0:0] tmpINTERRUPT_0__MINUS_net;
	electrical [0:0] tmpSIOVREF__MINUS_net;

	cy_psoc3_pins_v1_10
		#(.id("8779b6d8-aa8d-40bd-83ff-ff66074f914a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MINUS
		 (.oe(tmpOE__MINUS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MINUS_net[0:0]}),
		  .analog({Net_2}),
		  .io({tmpIO_0__MINUS_net[0:0]}),
		  .siovref(tmpSIOVREF__MINUS_net),
		  .interrupt({tmpINTERRUPT_0__MINUS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MINUS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("4ae97e33-8d3d-4b88-96ff-7c0660387863"),
		  .source_clock_id(""),
		  .divisor(0),
