...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000394u)

/* UDB_0_0_1_CONFIG Address: CYDEV_UCFG_B1_P5_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_0_1_CONFIG_VAL ((const uint8 CYFAR *)0x4800039Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT3_AMUX, 0x2020u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0x08u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW4, 0x20u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0x28u);
